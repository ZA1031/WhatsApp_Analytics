...
/** Message sent from the worker to the UI with the copied messages */
export interface CopiedMessagesMessage {
    type: "update-copied-messages";
    copiedMessages: {
...
export interface ContainingMessagesMessage {
    type: "update-containing-messages";
    containingMessages: {
        word: string;
        containingMessages: {
            id: number;
