...
const MessagesStatsTable = () => {
    ...
    const lines: Line[] = [
        ...
        },
        {
            ...
            label: "🔗 with links",
            depth: 1,
            value: (stats?.withLinks ?? 0) + (stats?.withAttachmentsCount?.[AttachmentType.Video] ?? 0),
        },
        {
            type: "number",
            formatter: "integer",
        ...
        },
        {
            type: "number",
            formatter: "integer",
            label: "Copy messages sent",
            value: (stats?.copyMessagesFromSameCount || 0) + (stats?.copyMessagesFromOtherCount || 0),
        },
        {
            type: "number",
            formatter: "integer",
            label: "📄 From same member",
            depth: 1,
            value: stats?.copyMessagesFromSameCount
        },
        {
            type: "number",
            formatter: "integer",
            label: "📄 From other members",
            depth: 1,
            value: stats?.copyMessagesFromOtherCount
        },
        {
            type: "number",
            formatter: "integer",
