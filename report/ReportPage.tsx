...
import CopiedMessagesTable from "@report/components/cards/messages/CopiedMessagesTable";
import ContainingMessagesTable from "@report/components/cards/language/ContainingMessagesTable";
...
const ReportDashboard = () => {
    ...
    const sections: Section[] = useMemo(() => {
        ...
        // const copiedMessages = database.copiedMessages || [];
        ...
        return [
                    ...
                    platformInfo.support.edits
                        ...
                        [
                            <Card
                                ...
                                children={CopiedMessagesTable}
                                tooltip="This table shows messages that are similar to previous messages, along with their details."
                            />,
                        ]
                ),
            },
            {
                ...
                cards: [
                    ...
                    <Card
                        num={3}
                        title="Containing Messages"
                        children={ContainingMessagesTable}
                        tooltip="This table shows messages that contain specific words, along with their details."
                    />
                ],
            },
            {
