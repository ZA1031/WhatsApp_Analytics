const PLAUSIBLE_URL =
    typeof env !== "undefined" && env.isProd
        ? "https://p.chatanalytics.app"
        : "https://p.chatanalytics.app"; // Use a mock server or local endpoint for development
...
export const plausible = (name: "pageview" | string, props?: { [key: string]: string }) => {
    ...
    // if (PLAUSIBLE_URL === "http://localhost:3000") {
    //     console.warn("Plausible analytics is disabled in development.");
    //     return;
    // }
