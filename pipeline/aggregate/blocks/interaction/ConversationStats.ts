...
const fn: BlockFn<ConversationStats> = (database, filters, common, args) => {
    ...
    filterMessages((msg) => authorsCounts[msg.authorIndex]++, database, filters, common);
    ...
    filterMessages(processMessage, database, filters, common, { channels: true, authors: false, time: true });
